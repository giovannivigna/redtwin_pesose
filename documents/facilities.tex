...
shared clusters available to any researcher on campus, including
Infiniband-interconnected MPI nodes, several large-memory nodes, GPU nodes,
and high-performance parallel storage; CSC staff hold backgrounds in science
or mathematics and assist users with porting, developing, and optimizing code.
The UCSB campus cloud, part of the NSF Aristotle project, provides additional
elastic capacity for the larger twins.
\todoverify{confirm the current CSC cluster generation, since the previously
recorded V100 and M2050 systems date from 2018}
...
\todoverify{describe the isolated VLAN or air-gapped segment used for twins and
who administers it}
...
\todoverify{name the responsible UCSB IT organization and state the current
...
\subsection{Campus systems for the operational evaluation}
\todoverify{name the responsible ASU IT organization and state the current
status of the arrangement for the campus evaluation of Section~7}
