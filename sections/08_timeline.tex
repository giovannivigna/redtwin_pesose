...
Q5--Q6 & Logic-based invariants and attack-graph preservation; quantitative
   ...
   & $\geq 90\%$ soundness and $\geq 75\%$ precision; mock-backed surface
...
Two dependencies govern this schedule. The ZMap extensions of Q2--Q3 gate the
quality of the capture that the replication of Q4 consumes, and they are scheduled early, with acceptance criteria stated in terms
of downstream usability rather than of feature completeness. The fidelity measure of Q5 gates the interpretation of every result of
Thrust~3, and it precedes the analysis milestones. Should Q5 miss its soundness
target, Q6--Q8 will proceed on the reference networks, where ground truth
substitutes for the measure, while the work on fidelity continues in
parallel.
