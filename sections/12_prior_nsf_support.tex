...
Operation (ACTION).} IIS-2228976, \$21,994,201, 6/1/2023--5/31/2028. PIs:
G.~Vigna and C.~Kruegel et al.
\emph{Intellectual merit:} using novel knowledge-modeling and logic reasoning
...
\emph{Broader impacts:} increased ability to detect attacks and respond to
breaches at scale, and support for a large cohort of student researchers.
\emph{Publications:} representative results
include~\cite{fleischer23:actor,chainreactor}.
\todoverify{list up to five ACTION publications}
\emph{Products:} the institute maintains the Global Accessible Test
Infrastructure (GATE), emulated topologies representing smart cities,
chemical plants, water systems, and manufacturing plants, available to the
research community~\cite{action}.
...
CNS-2334709, \$1,200,000, 2024--2027. PIs: G.~Vigna and C.~Kruegel.
\emph{Intellectual merit:} the first multi-chain program analysis platform
operating directly on low-level smart-contract bytecode, letting analyses be
reused across blockchain environments.
\emph{Broader impacts:} protection of Web3 applications, where attacks on
smart contracts pose a significant threat to users.
\emph{Publications:} \todoverify{list up to five, or ``No publications were
produced under this award.''}
\emph{Products:} \todoverify{name the platform and where it is released}
...
\emph{Intellectual merit:} minimized the browser attack surface by letting
website operators limit available JavaScript functionality.
\emph{Broader impacts:} uncovered extensions leaking personally identifiable
...
T.~Bao et al.
\emph{Intellectual merit:} improves the usability of symbolic execution.
\emph{Broader impacts:} a human-interactive framework lowering the expertise
symbolic analysis requires.
\emph{Publications:} \todoverify{list up to five, or ``No publications were
produced under this award.''}
\emph{Products:} \todoverify{where the framework and datasets are released}
...
\emph{Intellectual merit:} enables autonomous symbolic execution by learning
analysis strategies from human analysts.
\emph{Broader impacts:} an AI-enabled autonomous symbolic execution framework
and an associated educational program.
\emph{Publications:} \todoverify{award began 2025; list publications or ``No
publications were produced under this award.''}
\emph{Products:} \todoverify{where the framework will be released}
\emph{Relation to this proposal:} no overlap.
