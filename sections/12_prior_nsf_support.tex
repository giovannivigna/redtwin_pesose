...
\emph{Intellectual merit:} the first multi-chain program analysis platform operating directly on low-level smart-contract bytecode, letting analyses be reused across blockchain environments.
\emph{Broader impacts:} protection of Web3 applications, where attacks on smart contracts pose a significant threat to users.
...
\emph{Products:} No product were produced under this award
\emph{Relation to this proposal:} no overlap.
